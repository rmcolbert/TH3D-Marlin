...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  //#define ENABLE_LEVELING_FADE_HEIGHT //Disabled due to Z Offset issues
...
#if ENABLED(CR10) || ENABLED(CR10_MINI) || ENABLED(CR10_S4) || ENABLED(CR10_S5) || ENABLED(CR10S) || ENABLED(CR10S_MINI) || ENABLED(CR10S_S4) || ENABLED(CR10S_S5) || ENABLED(TORNADO) || ENABLED(TAZ5) || ENABLED(ENDER3) || ENABLED(ALFAWISE_U10) || ENABLED(ENDER3_DUALBOARD) || ENABLED(FT5_12864LCD)
...
#if ENABLED(FT5) && DISABLED(FT5_12864LCD)
